...
import {
  UserUnitProgressFindUnique,
  UserUnitProgressFindUniqueOrThrow,
  UserUnitProgressFindFirst,
  UserUnitProgressFindFirstOrThrow,
  UserUnitProgressFindMany,
  UserUnitProgressFindManyPaginated,
  UserUnitProgressCreate,
  UserUnitProgressCreateMany,
  UserUnitProgressCreateManyAndReturn,
  UserUnitProgressUpdate,
  UserUnitProgressUpdateMany,
  UserUnitProgressUpdateManyAndReturn,
  UserUnitProgressUpsert,
  UserUnitProgressDelete,
  UserUnitProgressDeleteMany,
  UserUnitProgressAggregate,
  UserUnitProgressCount,
  UserUnitProgressGroupBy,
} from "./UserUnitProgressHandlers.js";
import * as core from "./UserUnitProgressCore.js";
...
import type {
  UserUnitProgressFindUniqueShapeInput,
  UserUnitProgressFindUniqueOrThrowShapeInput,
  UserUnitProgressFindFirstShapeInput,
  UserUnitProgressFindFirstOrThrowShapeInput,
  UserUnitProgressFindManyShapeInput,
  UserUnitProgressFindManyPaginatedShapeInput,
  UserUnitProgressCountShapeInput,
  UserUnitProgressAggregateShapeInput,
  UserUnitProgressGroupByShapeInput,
  UserUnitProgressCreateShapeInput,
  UserUnitProgressCreateManyShapeInput,
  UserUnitProgressCreateManyAndReturnShapeInput,
  UserUnitProgressUpdateShapeInput,
  UserUnitProgressUpdateManyShapeInput,
  UserUnitProgressUpdateManyAndReturnShapeInput,
  UserUnitProgressUpsertShapeInput,
  UserUnitProgressDeleteShapeInput,
  UserUnitProgressDeleteManyShapeInput,
} from "../../guard/shapes.js";

export type UserUnitProgressRouteConfig<TCtx = unknown, TPrisma = any> = Omit<
...
> & {
  ...
  findUnique?: {
    ...
    shape?: UserUnitProgressFindUniqueShapeInput<TCtx>;
  ...
  findUniqueOrThrow?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressFindUniqueOrThrowShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  findFirst?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressFindFirstShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  findFirstOrThrow?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressFindFirstOrThrowShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  findMany?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressFindManyShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  findManyPaginated?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressFindManyPaginatedShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  count?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressCountShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  aggregate?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressAggregateShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  groupBy?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressGroupByShapeInput<TCtx>;
    progressive?: Record<string, ProgressiveVariantConfig>;
    progressiveStages?: Record<string, ProgressiveStage<TCtx, TPrisma>>;
  };
  create?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressCreateShapeInput<TCtx>;
  };
  createMany?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressCreateManyShapeInput<TCtx>;
  };
  createManyAndReturn?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressCreateManyAndReturnShapeInput<TCtx>;
  };
  update?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressUpdateShapeInput<TCtx>;
  };
  updateMany?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressUpdateManyShapeInput<TCtx>;
  };
  updateManyAndReturn?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressUpdateManyAndReturnShapeInput<TCtx>;
  };
  upsert?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressUpsertShapeInput<TCtx>;
  };
  delete?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressDeleteShapeInput<TCtx>;
  };
  deleteMany?: {
    before?: RequestHandler[];
    after?: RequestHandler[];
    shape?: UserUnitProgressDeleteManyShapeInput<TCtx>;
  };
};
...
export function UserUnitProgressRouter<TCtx = unknown, TPrisma = any>(
  config: UserUnitProgressRouteConfig<TCtx, TPrisma> = {},
) {
  const router = express.Router();

  const customPrefix = normalizePrefix(config.customUrlPrefix || "");
  const modelPrefix =
    config.addModelPrefix !== false ? "/userunitprogress" : "";
  ...
  if (config.enableAll || config.findFirst) {
    ...
    router.get(
      ...
      UserUnitProgressFindFirst as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findFirstOrThrow) {
    ...
    router.get(
      ...
      UserUnitProgressFindFirstOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findManyPaginated) {
    ...
    router.get(
      ...
      UserUnitProgressFindManyPaginated as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.aggregate) {
    ...
    router.get(
      ...
      UserUnitProgressAggregate as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.count) {
    ...
    router.get(
      ...
      UserUnitProgressCount as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.groupBy) {
    ...
    router.get(
      ...
      UserUnitProgressGroupBy as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUniqueOrThrow) {
    ...
    router.get(
      ...
      UserUnitProgressFindUniqueOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUnique) {
    ...
    router.get(
      ...
      UserUnitProgressFindUnique as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findMany) {
    ...
    router.get(
      ...
      UserUnitProgressFindMany as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled) {
  ...
  if (config.enableAll || config.createManyAndReturn) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressCreateManyAndReturn as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.createMany) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressCreateMany as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.create) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressCreate as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.updateManyAndReturn) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressUpdateManyAndReturn as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.updateMany) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressUpdateMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.update) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressUpdate as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.upsert) {
    ...
    router.patch(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressUpsert as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.deleteMany) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressDeleteMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.delete) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      UserUnitProgressDelete as RequestHandler,
      ...after,
      respond,
    );
  }
