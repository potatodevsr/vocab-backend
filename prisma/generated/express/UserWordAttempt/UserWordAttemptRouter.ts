...
export type UserWordAttemptRouteConfig<TCtx = unknown, TPrisma = any> = Omit<
...
export function UserWordAttemptRouter<TCtx = unknown, TPrisma = any>(
  config: UserWordAttemptRouteConfig<TCtx, TPrisma> = {},
) {
  ...
  if (config.enableAll || config.findFirst) {
    ...
    router.get(
      ...
      UserWordAttemptFindFirst as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findFirstOrThrow) {
    ...
    router.get(
      ...
      UserWordAttemptFindFirstOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findManyPaginated) {
    ...
    router.get(
      ...
      UserWordAttemptFindManyPaginated as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.aggregate) {
    ...
    router.get(
      ...
      UserWordAttemptAggregate as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.count) {
    ...
    router.get(
      ...
      UserWordAttemptCount as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.groupBy) {
    ...
    router.get(
      ...
      UserWordAttemptGroupBy as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUniqueOrThrow) {
    ...
    router.get(
      ...
      UserWordAttemptFindUniqueOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUnique) {
    ...
    router.get(
      ...
      UserWordAttemptFindUnique as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findMany) {
    ...
    router.get(
      ...
      UserWordAttemptFindMany as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled) {
  ...
  if (config.enableAll || config.createManyAndReturn) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptCreateManyAndReturn as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.createMany) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptCreateMany as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.create) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptCreate as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.updateManyAndReturn) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptUpdateManyAndReturn as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.updateMany) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptUpdateMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.update) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptUpdate as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.upsert) {
    ...
    router.patch(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptUpsert as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.deleteMany) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptDeleteMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.delete) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      UserWordAttemptDelete as RequestHandler,
      ...after,
      respond,
    );
  }
