...
export type LearningSessionRouteConfig<TCtx = unknown, TPrisma = any> = Omit<
...
export function LearningSessionRouter<TCtx = unknown, TPrisma = any>(
  config: LearningSessionRouteConfig<TCtx, TPrisma> = {},
) {
  ...
  if (config.enableAll || config.findFirst) {
    ...
    router.get(
      ...
      LearningSessionFindFirst as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findFirstOrThrow) {
    ...
    router.get(
      ...
      LearningSessionFindFirstOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findManyPaginated) {
    ...
    router.get(
      ...
      LearningSessionFindManyPaginated as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.aggregate) {
    ...
    router.get(
      ...
      LearningSessionAggregate as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.count) {
    ...
    router.get(
      ...
      LearningSessionCount as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.groupBy) {
    ...
    router.get(
      ...
      LearningSessionGroupBy as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUniqueOrThrow) {
    ...
    router.get(
      ...
      LearningSessionFindUniqueOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUnique) {
    ...
    router.get(
      ...
      LearningSessionFindUnique as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findMany) {
    ...
    router.get(
      ...
      LearningSessionFindMany as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled) {
  ...
  if (config.enableAll || config.createManyAndReturn) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionCreateManyAndReturn as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.createMany) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionCreateMany as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.create) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionCreate as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.updateManyAndReturn) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionUpdateManyAndReturn as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.updateMany) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionUpdateMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.update) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionUpdate as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.upsert) {
    ...
    router.patch(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionUpsert as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.deleteMany) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionDeleteMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.delete) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      LearningSessionDelete as RequestHandler,
      ...after,
      respond,
    );
  }
