...
export type UserWordProgressRouteConfig<TCtx = unknown, TPrisma = any> = Omit<
...
export function UserWordProgressRouter<TCtx = unknown, TPrisma = any>(
  config: UserWordProgressRouteConfig<TCtx, TPrisma> = {},
) {
  ...
  if (config.enableAll || config.findFirst) {
    ...
    router.get(
      ...
      UserWordProgressFindFirst as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findFirstOrThrow) {
    ...
    router.get(
      ...
      UserWordProgressFindFirstOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findManyPaginated) {
    ...
    router.get(
      ...
      UserWordProgressFindManyPaginated as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.aggregate) {
    ...
    router.get(
      ...
      UserWordProgressAggregate as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.count) {
    ...
    router.get(
      ...
      UserWordProgressCount as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.groupBy) {
    ...
    router.get(
      ...
      UserWordProgressGroupBy as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUniqueOrThrow) {
    ...
    router.get(
      ...
      UserWordProgressFindUniqueOrThrow as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findUnique) {
    ...
    router.get(
      ...
      UserWordProgressFindUnique as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled)
  ...
  if (config.enableAll || config.findMany) {
    ...
    router.get(
      ...
      UserWordProgressFindMany as RequestHandler,
      ...after,
      respond,
    );
    if (postReadsEnabled) {
  ...
  if (config.enableAll || config.createManyAndReturn) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressCreateManyAndReturn as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.createMany) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressCreateMany as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.create) {
    ...
    router.post(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressCreate as RequestHandler,
      ...after,
      respondCreated,
    );
  }
  if (config.enableAll || config.updateManyAndReturn) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressUpdateManyAndReturn as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.updateMany) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressUpdateMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.update) {
    ...
    router.put(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressUpdate as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.upsert) {
    ...
    router.patch(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressUpsert as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.deleteMany) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressDeleteMany as RequestHandler,
      ...after,
      respond,
    );
  }
  if (config.enableAll || config.delete) {
    ...
    router.delete(
      ...
      setShape(opConfig),
      ...before,
      UserWordProgressDelete as RequestHandler,
      ...after,
      respond,
    );
  }
