...
import { OPERATION_DEFS, isOperationEnabled, READ_OPERATION_NAMES } from './operationDefinitions.js'
import { getEnv, normalizePrefix } from './misc.js'
...
export function renderDocs(modelName: string, config: DocsConfig, ctx: DocsModelContext): string {
  ...
  const findManyFetchExample =
    'import { encodeQueryParams } from "./client/encodeQueryParams.js"\n\n' +
